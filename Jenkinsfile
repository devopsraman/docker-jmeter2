	      ...
	      stage ('Run jmeter scripts on docker') {
			  ...
			  steps {
				sh '''
				  ...
				  /usr/local/bin/docker run -i --rm  devopsraman/jmeter:3.3 /bin/bash -c 'cat > /home/jmeter/test1.jmx && jmeter -n -t /home/jmeter/test1.jmx -DTESTHOST=nbs-mortgages-remo-webapp.dev.mortgages.nationwide.co.uk -l /home/jmeter/jmeter2.csv 1>/dev/null && cat /home/jmeter/jmeter2.csv' < tests/test1.jmx > reports/jmeter/jmeter2.cs
